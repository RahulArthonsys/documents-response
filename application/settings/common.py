...
try:
    ...
    load_dotenv(os.path.join(dirname(dirname(dirname(abspath(__file__)))), '.env'))
except ImportError:
    pass
...
GEMINI_API_KEY = os.environ.get('GEMINI_API_KEY', 'AIzaSyCQ5wX9jIxXD75wLZ5GFOZDVshLAbr20Eg')
